...
CREATE TABLE `shoppingcart` (
  ...
  UNIQUE KEY `shoppingCartNumber_UNIQUE` (`shoppingCartNumber`),
  KEY `shoppingCartToCustomers_idx` (`customerNumber`),
  CONSTRAINT `shoppingCartToCustomers` FOREIGN KEY (`customerNumber`) REFERENCES `customers` (`customerNumber`)
