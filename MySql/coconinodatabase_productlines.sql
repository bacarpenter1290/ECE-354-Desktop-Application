...
CREATE TABLE `productlines` (
  ...
  UNIQUE KEY `productLineNumber_UNIQUE` (`productLineNumber`)
...
INSERT INTO `productlines` VALUES (1,'Beauty','Beauty products for everyone'),(2,'Electronics','Electronics that last'),(3,'Furniture','High Quality Furniture'),(4,'Home','Goods to make a place your home'),(5,'Clothing','Best clothing you can find');
